...
export const ProductTile = (props: { data: TProduct; onLoad: () => void }) => {
  ...
  return (
    <Link to={linkPath}>
      <div className=' flex h-44 overflow-hidden rounded-xl shadow-tile transition-shadow duration-200 ease-out hover:shadow-tile-up sm:aspect-[2/3] sm:h-[27rem] sm:flex-col '>
        ...
        <div className='mx-2 my-4 flex flex-col justify-between text-xs font-semibold uppercase tracking-wider sm:mx-3 sm:my-3 sm:basis-1/4'>
